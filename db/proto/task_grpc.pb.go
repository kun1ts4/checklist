...
type TaskServiceClient interface {
	...
	GetTasks(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*GetTasksResponse, error)
...
func (c *taskServiceClient) GetTasks(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*GetTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TaskServiceServer interface {
	...
	GetTasks(context.Context, *GetTaskRequest) (*GetTasksResponse, error)
...
func (UnimplementedTaskServiceServer) GetTasks(context.Context, *GetTaskRequest) (*GetTasksResponse, error) {
